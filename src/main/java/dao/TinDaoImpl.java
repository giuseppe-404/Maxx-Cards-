...
public class TinDaoImpl extends ConfezionatoDaoImpl implements TinDao{
	private static final String BEAN_NAME = "tin";
	...
	public TinDaoImpl(DataSource ds) {
		super(ds);
		this.ds = ds;
	}
	
	@Override
	public synchronized boolean saveTin(TinBean bean) throws SQLException {
	...
	@Override
	public synchronized boolean deleteTin(int id) throws SQLException {
	...
	public synchronized List<TinBean> retrieveFiltered(TinBean prod) throws SQLException{
	...
	public synchronized List<TinBean> retrieveFiltered(TinBean prod, int page, int limit) throws SQLException{
		List<TinBean> list = new ArrayList<>();
		StringBuilder sql = new StringBuilder("SELECT "+SUPER_NAME+".*, lingua, id_set FROM "
				+ SUPER_NAME + " JOIN " + MIDDLE_NAME + " ON " + SUPER_NAME + ".id = " + MIDDLE_NAME + 
				".id JOIN " + TABLE_NAME + " ON " + SUPER_NAME + ".id = " + TABLE_NAME + ".id JOIN "+BEAN_NAME+" ON "+SUPER_NAME+" .id = "+
	...
	public synchronized TinBean retrieveByKey(int id) throws SQLException{
	...
	protected synchronized boolean buildProdottoFilter(StringBuilder sql, ArrayList<String> attribute, TinBean bean) {
