		...
		<section id=product_section>
			...
			<section id="data_section">
				<section id="txt_section">
					<h1>${trappola.nomeIt}</h1>
					<p>Nome inglese: ${trappola.nomeEn}</p>
					<p>Nome giapponese: ${trappola.nomeJp}</p>
					<p>Punteggio in Genesys: ${trappola.punteggio}</p>
					<p>Tipologia: ${trappola.tipologia}</p>
					<p>${trappola.testo}</p>
				</section>
			</section>
		</section>
