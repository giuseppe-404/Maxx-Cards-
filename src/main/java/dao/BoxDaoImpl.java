...
public class BoxDaoImpl extends ConfezionatoDaoImpl implements BoxDao{
	private static final String BEAN_NAME = "box";
	...
	public BoxDaoImpl(DataSource ds) {
		super(ds);
		this.ds = ds;
	}
	
	@Override
	public synchronized boolean saveBox(BoxBean bean) throws SQLException {
	...
	@Override
	public synchronized boolean deleteBox(int id) throws SQLException {
	...
	public synchronized List<BoxBean> retrieveFiltered(BoxBean prod) throws SQLException{
	...
	public synchronized List<BoxBean> retrieveFiltered(BoxBean prod, int page, int limit) throws SQLException{
		List<BoxBean> list = new ArrayList<>();
		StringBuilder sql = new StringBuilder("SELECT "+SUPER_NAME+".*, lingua, id_set FROM "
				+ SUPER_NAME + " JOIN " + MIDDLE_NAME + " ON " + SUPER_NAME + ".id = " + MIDDLE_NAME + 
				".id JOIN " + TABLE_NAME + " ON " + SUPER_NAME + ".id = " + TABLE_NAME + ".id JOIN "+BEAN_NAME+" ON "+SUPER_NAME+" .id = "+
	...
	public synchronized BoxBean retrieveByKey(int id) throws SQLException{
	...
	protected synchronized boolean buildProdottoFilter(StringBuilder sql, ArrayList<String> attribute, BoxBean bean) {
